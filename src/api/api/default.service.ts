...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public countDevices(observe?: 'body', reportProgress?: boolean): Observable<Count>;
    public countDevices(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Count>>;
    public countDevices(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Count>>;
    public countDevices(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public getUserLogs(offset: number, limit: number, username?: string, type?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (username !== undefined && username !== null) {
            queryParameters = queryParameters.set('userId', <any>username);
        }
        if (type !== undefined && type !== null) {
            queryParameters = queryParameters.set('type', <any>type);
        }
